...
def test_get_followable(): #Tests list of all followable users
    followable = User.get_followable(user,db)
    assert(followable == {'Ablion73': 'follow', 'alexabarra': 'follow', 'Arman1992': 'unfollow', 'Bods1940': 'follow', 'Calasts53': 'follow', 'Careekeres': 'follow', 'Carther1949': 'unfollow', 'Cathery': 'follow', 'CItester': 'follow', 'Crinsonast1984': 'follow', 'Dideas85': 'follow', 'Drand1943': 'follow', 'Facepow': 'follow', 'Feck1968': 'follow', 'Gaveressake': 'follow', 'Giarturner': 'follow', 'Goiderearsur': 'follow', 'Hadet1965': 'follow', 'Hiserus': 'follow', 'Horgy1990': 'unfollow', 'Hurs1997': 'follow', 'Jonathan': 'follow', 'Kning1982': 'follow', 'kylejen': 'follow', 'Locies': 'unfollow', 'Marknow': 'follow', 'MatteoGisondi': 'follow', 'Milloon': 'unfollow', 'Myseat': 'follow', 'Prempeh': 'follow', 'Ristraid': 'follow', 'Sequith': 'unfollow', 'Slogummid': 'follow', 'Somprood': 'follow', 'Sone1983': 'follow', 'Suchown': 'follow', 'Sups1944': 'follow', 'Swentorme1935': 'unfollow', 'Thdow1971': 'follow', 'Thensted': 'follow', 'Thetting': 'follow', 'Theyear': 'follow', 'Togand': 'follow', 'Trumsess1943': 'follow', 'Usithed66': 'follow', 'Weaught': 'unfollow', 'Weververnly': 'follow', 'Whatithas': 'follow', 'Whimseeplis': 'unfollow', 'Wilegire1937': 'follow', 'Winglersen1989': 'follow', 'Witive': 'follow', 'Wrove1935': 'follow'})
...
def test_get_following():
    ...
    assert(usernames == {'Arman1992', 'Milloon', 'Swentorme1935', 'Whimseeplis', 'Horgy1990', 'Weaught', 'Horgy1990', 'Sequith', 'Locies', 'Carther1949'})

def test_get_followers():
    users = user.get_followers(db)
    usernames = set(map(lambda x:x.username,users))
    assert(usernames == {'Theyear', 'Marknow', 'Facepow', 'Hadet1965', 'Hadet1965', 'Hiserus', 'Cathery', 'Sups1944', 'Slogummid', 'Sone1983', 'MatteoGisondi', 'Prempeh'})
