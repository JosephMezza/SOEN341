...
def test_get_usernames():
    ...
    assert(User.get_usernames(db) == ['Ablion73', 'alexabarra', 'Arman1992', 'Bods1940', 'Calasts53', 'Careekeres', 'Carther1949', 'Cathery', 'CItester', 'Crinsonast1984', 'Dideas85', 'Drand1943', 'Facepow', 'Feck1968', 'Gaveressake', 'Giarturner', 'Goiderearsur', 'Hadet1965', 'Hiserus', 'Horgy1990', 'Hurs1997', 'Jonathan', 'Kning1982', 'kylejen', 'Locies', 'Marknow',
...
def test_get_user():
    ...
    assert(User.get_user(user) == (3, 'Thithe', 'GeneCRodriguez@dayrep.com', 'Gene',
...
def test_get_following():
    ...
    assert(usernames == {'Arman1992', 'Milloon', 'Swentorme1935', 'Whimseeplis',
...
def test_get_followers():
    ...
    usernames = set(map(lambda x: x.username, users))
    assert(usernames == {'Theyear', 'Marknow', 'Facepow', 'Hadet1965', 'Hadet1965',
